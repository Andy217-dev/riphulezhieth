    ...
    /***/ 537666: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        ...
        var eMb = function (a, b, c) {
          ...
          c4 = function (a, b) {
            a = a.ySa.get(b);
            if (null == a) throw new hMb("ref does not exists");
            return a;
          },
          f4 = function (a) {
            const b = (c, d) => {
            ...
            return {
              Ak: (c) => ({ type: "string", value: c }),
              Ns: (c) => b(c, "toWidgetState"),
              Ms: (c) => b(c, "toWidgetData"),
              Nu: (c) => b(c, "toWidgetData"),
            };
          },
          h4 = function (a, b) {
            if (0 === a.length)
            ...
            return {
              Ak: (e) => ({ type: "string", value: e }),
              Ns: (e) => d(e, "toWidgetState"),
              Ms: (e) => d(e, "toWidgetData"),
              Nu: (e) => d(e, "toWidgetData"),
            };
          },
          i4 = function (a) {
            const b = (c, d) => {
            ...
            return {
              Ak: (c) => {
                if (!Number.isFinite(c)) throw new iMb(c);
            ...
            return {
              ...
              Ns: (d) => {
                if ("dict" !== (null === d || void 0 === d ? void 0 : d.type))
                  throw new e4("record", d);
                const e = {};
                for (const f of Object.keys(a)) {
                  const [g, h] = a[f],
                    k = h.Ns(d.value.get(g));
                  null != k && (e[f] = k);
                }
                return e;
              },
          ...
          m4 = function (a) {
            return {
              Ak: (b) => ({ type: "list", value: b.map((c) => a.Ak(c)) }),
              Ns: (b) => {
                if ("list" !== (null === b || void 0 === b ? void 0 : b.type))
                  throw new e4("list", b);
                return b.value.filter(zb).map((c) => a.Ns(c));
              },
              Ms: (b) => {
                if ("list" !== (null === b || void 0 === b ? void 0 : b.type))
                  throw new d4("list", b);
          ...
          lMb = function (a) {
            return {
              Ak: (b) => {
                if (null != b) return a.Ak(b);
              },
              Ns: (b) => {
                if (null != b) return a.Ns(b);
              },
              Ms: (b) => {
                if (null != b) return a.Ms(b);
              },
              Nu: (b) => {
                if (null != b) return a.Nu(b);
              },
            };
          },
          n4 = function (a, b) {
          ...
          mMb = function (a) {
            const b = () => a.Im.Xz.get(a.Ye.mG) || o4;
            return {
              rS: function () {
                return a.Im.tj
                  ? 3
          ...
          qMb = function (a, b, c, d, e, f) {
            ...
            async function h() {
              var u;
              const v = f.Ej("submit_response", {
                Uz: { name: "ui.rendering.form.submit_response" },
              });
              var x = {
                Nma: m,
                U4a: p,
              ...
              e && gMb({ span: v, ya: e, event: nMb, props: x });
              const { results: y, lf: z, Vsa: A } = r();
              if (null != z && g())
                if (
                  (x =
                    null ===
                      (u = a.Ye.fields.first(({ value: I }) => {
                        var J;
                        return !(
                          null ===
                            (J = I.options.first(
                  ...
                  "poll" === p &&
                    A &&
                    A !== z &&
                    (E = p4({ Fia: y, wE: x.id, QT: A }));
                  E = oMb({ uDa: E, wE: x.id, QT: z });
                  l("field_results_created", v);
                  q4(() => {
                    a.Wl(() => ({
                      Xz: t({ lf: z, bK: z, results: E }),
                      K_: !0,
                    }));
                  });
                  l("submission_set", v);
                  ...
                  null === d || void 0 === d
                    ...
                    : __c.ij(d, {
                        Zt: O("izckBA"),
                        group: pMb,
                        aQ: { Bx: O("mQhziQ"), onClick: h },
                      });
                  var H = p4({ Fia: E, wE: x.id, QT: z });
                  A && (H = oMb({ uDa: H, wE: x.id, QT: A }));
                  q4(() => {
                    a.Wl({
                      ...C,
                      ...(A && { Xz: t({ lf: A, bK: A, results: H }) }),
                    });
                  });
                } else v.abort();
              else v.abort();
            ...
            async function k(u) {
              ...
              const x = r(),
                y =
                  null ===
                    (v = a.Ye.fields.first(({ value: C }) => {
                      var E;
                      return !(
                        null ===
                          (E = C.options.first(({ value: H }) => H.id === u)) ||
                        void 0 === E ||
                        !E.value
                      );
                    })) || void 0 === v
              ...
              if (y) {
                var z = a.Im,
                  A = p4({ Fia: x.results, wE: y.id, QT: u });
                q4(() => {
                  a.Wl(() => ({
                    Xz: t({ lf: void 0, bK: void 0, results: A }),
                    vA: void 0,
                    K_: !0,
                  }));
                });
          ...
          p4 = function ({ Fia: a, wE: b, QT: c }) {
            var d;
            const e =
              null !== (d = a.fields.get(b)) && void 0 !== d
                ? d
                : { id: b, kJ: new Map(), total: 0 };
            var f;
            d = Math.max(
              0,
              (null !== (f = e.kJ.get(c)) && void 0 !== f ? f : 0) - 1
            );
            f = new Map(e.kJ);
            0 < d ? f.set(c, d) : f.delete(c);
            return {
              fields: r4(a.fields, b, {
                id: b,
                kJ: f,
          ...
          oMb = function ({ uDa: a, wE: b, QT: c }) {
            ...
            const e =
              null !== (d = a.fields.get(b)) && void 0 !== d
                ...
                : { id: b, kJ: new Map(), total: 0 };
            var f;
            d = (null !== (f = e.kJ.get(c)) && void 0 !== f ? f : 0) + 1;
            return {
              fields: r4(a.fields, b, {
                id: b,
                kJ: r4(e.kJ, c, d),
          ...
          s4 = function (a, b) {
            var c;
            return ((null === (c = a.Fwa) || void 0 === c
              ? void 0
              : c.get(a.document.language || "en")) || [])[sMb[b]];
          },
          tMb = async function () {
            var { Gwa: a } = await __webpack_require__
              .me(134787)
              .then(() => ({
              ...
              m.push({
                ...
                placement: a
                  ? {
                      ...
                      gridRowStart: `${p + q}`,
                      gridRowEnd: `${p + q + 1}`,
                      padding: t.padding ? uMb(t.padding) : void 0,
          ...
          w4 = function (a, b) {
            ...
            __c.w(!0);
            __c.w(!0);
            const { ea: c, a: d, b: e } = __c.St(a),
              { ea: f, a: g, b: h } = __c.St(b),
              k = (c + f) / 2;
          ...
          xMb = function ({ direction: a, text: b, background: c }) {
            return {
              id: "header",
              size: "auto",
              fill: c,
              padding: [20, 20, 16, 20],
              content: y4(b, { direction: A4(a), color: u4(x4(c), v4) }),
            };
          },
          AMb = function ({
            direction: a,
            ...
            3 === g || 4 === g || 5 === g
              ? ((b = (n = s4(b, "resultsPercentage"))
                  ? eMb(n, [e], b.document.language)
                  : __c.Gb("sUWUOA", [e])),
                (k = {
                  id: "percentage",
                  placement: {
            ...
            switch (b) {
              ...
              case 1:
                return {
                  type: "text",
                  pG: 1,
                  text: B4(a.messages.loading(), c, d, u4(e, DMb), u4(e, v4)),
                };
              case 2:
                return {
                  type: "text",
                  pG: 1,
                  text: B4(
                    s4(a.messages, "submitting") || O("wutQEA"),
                    c,
                    d,
                    u4(e, DMb),
                    u4(e, v4)
              ...
              case 3:
                return {
                  type: "text",
                  pG: 1,
                  text: B4(a.messages.offline(), c, d, u4(e, EMb), u4(e, v4)),
                };
              default:
                throw new F(b);
            }
          ...
          GMb = function ({
            ...
            var g = s4(b, "live") || O("/iw6+Q");
            const h = s4(b, "numVotes");
            d = h ? eMb(h, [d], b.document.language) : __c.Gb("6QpLYA", [d]);
            return [
              {
                id: "footer",
                size: "auto",
          ...
          KMb = function ({ direction: a, Zra: b, Lw: c, state: d }) {
            const e = w4("#000000", c);
            return {
              type: "layout",
              gridTemplateRows: ["10px", "1fr", "10px"],
              ...
              cells: [
                {
                  ...
                  content: (() => {
                    switch (d) {
                      case 5:
                        return y4(b, { direction: A4(a), color: "#00873d" });
                      case 6:
                        return y4(b, { direction: A4(a), color: "#c8001e" });
                      case 4:
                        return y4(b, { direction: A4(a), color: u4(c, JMb) });
                      default:
                        return y4(b, { direction: A4(a) });
                    }
                  })(),
                },
                5 === d || 6 === d
          ...
          MMb = function ({ direction: a, text: b, GZa: c, FQ: d, KM: e }) {
            const f = v4.includes(c),
              { h: g, s: h, ea: k } = __c.cu(c);
            ...
            return {
              ...
              content: vMb({
                direction: z4(a),
                Vk: null === e || void 0 === e ? void 0 : e.submit,
                onMouseEnter: null === e || void 0 === e ? void 0 : e.yqa,
                onMouseLeave: null === e || void 0 === e ? void 0 : e.zqa,
                onMouseDown: null === e || void 0 === e ? void 0 : e.xqa,
                onMouseUp: null === e || void 0 === e ? void 0 : e.Aqa,
                background: {
                  type: "color",
                  color: 2 === d ? m : 1 === d ? l : c,
          ...
          OMb = function ({
            ...
            return l
                      ...
                      cells: [
                        {
                          ...
                          content: {
                            ...
                            fontFamily: d,
                            text: h
                              ? s4(c, "correctLabel") || O("i3mNPA")
                              : s4(c, "incorrectLabel") || O("As1GTA"),
                            fontSize: NMb,
                            fontWeight: "bold",
                            textAlign: "center",
                            direction: A4(b),
                        ...
                        },
                        {
                          ...
                          content: {
                            ...
                            pG: 0,
                            fontFamily: d,
                            text: s4(c, "responseSaved") || O("xSH8Og"),
                            fontSize: C4,
                            Pa: 0.2,
                            textAlign: "center",
                            direction: A4(b),
              ...
              : ((f = f === k ? u4(f, v4) : f),
                [
                  MMb({ direction: b, text: e, GZa: f, FQ: m, KM: a }),
                  {
                    id: "quiz_status",
                    size: "auto",
                    padding: [8, 20, 10, 20],
        ...
        var l4 = class {
            ...
            toArray() {
              return this.QDa.map(({ value: a }) => a);
            }
            first(a) {
              const b = this.list.value.first(
                a ? (c) => a(b4(this, c)) : void 0
              );
              if (null != b) return b4(this, b);
            }
            last(a) {
            ...
            next(a, b) {
              var c = b ? (d) => b(b4(this, d)) : void 0;
              a = c4(this, a);
              c = this.list.value.next(a, c);
              if (null != c) return b4(this, c);
            }
            Jc(a, b) {
              var c = b ? (d) => b(b4(this, d)) : void 0;
              a = c4(this, a);
            ...
            map(a) {
              return this.list.value.map((b, c) => a(b4(this, b), c));
            }
            filter(a) {
              return this.list.value
                .filter((b, c) => a(b4(this, b), c))
                .map((b) => b4(this, b));
            }
            forEach(a) {
              return this.list.value.forEach((b, c) => a(b4(this, b), c));
            }
            some(a) {
              return this.list.value.some((b) => a(b4(this, b)));
            }
            constructor(a, b) {
              l4.j(this);
              this.Jz = b;
              this.ESa = new WeakMap();
              this.ySa = new WeakMap();
              __c.B("list" === a.type);
              this.list = a;
            }
          },
          kMb = class extends l4 {
            replace(a, b) {
              a = c4(this, a);
              b = this.list.value.replace(a, this.Jz.Ak(b));
              return b4(this, b);
            }
            FM(a, b) {
              a = null != a ? c4(this, a) : void 0;
              b = this.list.value.FM(a, this.Jz.Ak(b));
              return b4(this, b);
            }
            GM(a, b) {
              a = null != a ? c4(this, a) : void 0;
              return this.list.value
                .GM(
                  a,
                  b.map((c) => this.Jz.Ak(c))
                )
                .map((c) => b4(this, c));
            }
            insertBefore(a, b) {
              a = null != a ? c4(this, a) : void 0;
              b = this.list.value.insertBefore(a, this.Jz.Ak(b));
              return b4(this, b);
            }
            append(a) {
              a = this.list.value.append(this.Jz.Ak(a));
              return b4(this, a);
            }
            prepend(a) {
              a = this.list.value.prepend(this.Jz.Ak(a));
              return b4(this, a);
            }
            delete(a) {
              a = c4(this, a);
        ...
        var SMb = k4({
            type: ["t", h4(["text2"], "text2"), "readonly"],
            text: [
              "te",
              (function () {
                const a = (b) => {
                ...
                return {
                  Ak: (b) => ({ type: "text2", value: b }),
                  Ns: (b) => {
                    if (
                      "text2" !== (null === b || void 0 === b ? void 0 : b.type)
                    )
                      throw new e4("text2", b);
                    return b.value;
                  },
                  Ms: a,
                  Nu: a,
          ...
          E4 = n4({ text2: SMb }, (a) => a.type),
          TMb = k4({ id: ["i", f4("")], label: ["l", E4] }),
          UMb = m4(TMb),
          VMb = m4(f4("")),
          WMb = k4({
            type: ["t", h4(["select"], "select"), "readonly"],
            id: ["i", f4("")],
            label: ["l", E4],
            options: ["o", UMb],
            V: ["c", i4(0)],
          ...
          XMb = n4({ select: WMb }, (a) => a.type),
          YMb = m4(XMb),
          ZMb = n4({ select: WMb }, (a) => a.type),
          $Mb = m4(ZMb),
          aNb = k4({ label: ["l", E4] }),
          bNb = k4({}),
          cNb = h4(["l", "r"], "l"),
          dNb = k4({
            ...
            border: [
              ...
              (function () {
                ...
                return {
                  Ak: (b) => ({ type: "stroke", value: b }),
                  Ns: (b) => {
                    if (
                      "stroke" !==
                      (null === b || void 0 === b ? void 0 : b.type)
                    )
                      throw new e4("stroke", b);
                    return b.value;
                  },
                  Ms: a,
                  Nu: a,
          ...
          eNb = dNb.Rc({
            type: ["t", h4(["quiz"], "quiz"), "readonly"],
            fields: ["f", YMb],
            footer: ["fo", aNb],
          }),
          fNb = dNb.Rc({
            type: ["t", h4(["poll"], "poll"), "readonly"],
            fields: ["f", $Mb],
          });
        h4(["poll", "quiz"], "quiz");
        var gNb = n4({ quiz: eNb, poll: fNb }, (a) => a.type),
          o4 = {
            lf: void 0,
            bK: void 0,
            Vsa: void 0,
        ...
        var nMb = {
          ...
          Ff(a) {
            return __c.lB({
              ...
              location: a.location,
              toggle_value: a.sG,
              editing_context: null == a.ie ? void 0 : __c.mB(a.ie),
              performance_context: null == a.Cf ? void 0 : __c.DC(a.Cf),
            });
          },
        };
        var pMb = Symbol("UNABLE_TO_SUBMIT");
        var sMb = {
            resultsPercentage: 0,
            incorrectLabel: 1,
            responseSaved: 2,
          ...
          iNb = class {
            ...
            offline() {
              return s4(this, "offline") || O("nFbxIQ");
            }
            loading() {
              return s4(this, "loading") || O("2Q9Q+A");
            }
            constructor(a) {
              this.document = a;
              this.noa();
        ...
        var jNb = class {
          ...
          get border() {
            ...
            return { weight: a.border.weight, color: a.border.color, hPa: a.V };
          }
          constructor(a, b) {
            jNb.j(this);
            this.Px = a;
        ...
        var kNb = class {
          static j(a) {
            __c.R(a, { xz: j4, Kz: j4, iC: j4, Lw: j4 });
          }
          get xz() {
            const a = this.Px.Ye.xz.color,
              b = this.Px.Ye.xz.pb;
            if (a) return { type: "color", color: a };
            if (b.ref) return { type: "gradient", pb: b.ref };
          }
          get Kz() {
            const a = this.Px.Ye.Kz.color,
              b = this.Px.Ye.Kz.pb;
            if (a) return { type: "color", color: a };
            if (b.ref) return { type: "gradient", pb: b.ref };
          }
          get iC() {
            if (!this.xz) return "#000000";
            switch (this.xz.type) {
              case "color":
                return this.xz.color;
              case "gradient":
                return this.xz.pb.Xm[0].color;
              default:
                throw new F(this.xz);
            }
          }
          get Lw() {
            if (!this.Kz) return "#000000";
            switch (this.Kz.type) {
              case "color":
                return this.Kz.color;
              case "gradient":
                return this.Kz.pb.Xm[0].color;
              default:
                throw new F(this.Kz);
            }
          }
        ...
        var B4 = (a, b, c, d, e) =>
          __c.Aj.Nc()
            ...
            .build();
        __c.gKa = {
          N0a: function (a, b, c, d, e, f, g, h, k) {
            g.Wg("forms");
            const { etb: l } = null !== d && void 0 !== d ? d : {},
              m = h.xy("ui.rendering.form"),
              n = { root: new PMb(), option: new PMb() },
              p = new iNb(b);
            return {
              toa: hNb,
              Jz: gNb,
                  ...
                  var r,
                    t = RMb(
                      ...
                      () => {
                        ...
                        "poll" === x &&
                          (r = y
                            ...
                            .subscribe(({ results: z, mG: A }) => {
                              q4(() => {
                                const C = new Map(q.Im.Xz);
                                var E;
                                C.set(A, {
                                  ...(null !== (E = C.get(A)) && void 0 !== E
                                    ? E
                                    : o4),
                                  results: z,
                                });
                        ...
                        y.getSettings({ xtb: () => q.Ye.Bda }).subscribe(
                          (z) => {
                            let A = z;
                            if (
                              3 !== z.status &&
                              ...
                              const H =
                                null !==
                                  (E =
                                    null === (C = q.Ye.fields.first()) ||
                                    void 0 === C
                                      ? void 0
                                      : C.value.SX.toArray()) && void 0 !== E
                                  ? E
                                  : [];
                              A = { status: 1, Cub: (I) => H.includes(I) };
                            }
                            q4(() => {
                              q.Wl({ settings: A });
                            });
              ...
              render: (q, r) => {
                var t = mMb(q);
                if (l && a) {
                  var u = l.get({ Nma: q.Ye.id, Rf: a, F8: c });
                  u = qMb(q, t, u, e, f, m);
                }
                a: {
                  var v = q.Ye,
                  ...
                  switch (v.type) {
                    ...
                    case "quiz":
                      ...
                      if (L && J && v) {
                        ...
                        I = t.ina() && 0 === H;
                        var Q = t.tna();
                        t = !!Q.lf && rMb(L.SX, Q.lf);
                        var P = z.minWidth,
                          U = z.minHeight,
                          Z = z4(A);
                        J = z.aoa
                          ? void 0
                          : xMb({ direction: A, text: L.label, background: J });
                        L = LMb({
                          KM: wMb(u),
                          direction: A,
                          options: L.options,
...
//# sourceMappingURL=sourcemaps/1ea52f48835cdd70.js.map
